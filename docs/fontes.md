...
- [Vídeo local de senha/admin no My USG](../assets/media/myusg-senha-autologin.mp4)

## Fontes externas úteis

- [ACEP Sonoguide](https://www.acep.org/sonoguide): guia de ultrassom de emergência por aplicações.
- [ACEP Ultrasound](https://www.acep.org/by-medical-focus/ultrasound): recursos e políticas de ultrassom em emergência.
- [POCUS Atlas](https://www.thepocusatlas.com/): biblioteca visual de achados em POCUS.
- [Core Ultrasound](https://coreultrasound.com/): vídeos e aulas de ultrassom de emergência.
- [POCUS 101](https://www.pocus101.com/): tutoriais introdutórios e protocolos.
- [LITFL Ultrasound Library](https://litfl.com/ultrasound-library/): revisões práticas para emergência e terapia intensiva.
- [Show Me The POCUS](https://showmethepocus.com/): vídeos curtos de achados e técnicas.
- [Rays of Gray](https://www.raysofgray.com/): recursos de aprendizagem visual.
...
## Fontes locais adicionais

Veja também [evidências dos arquivos originais](evidencias-arquivos-originais.md).
